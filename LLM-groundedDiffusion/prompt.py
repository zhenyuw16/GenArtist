...
import json
#b = json.load(open('cache/cache_demo_v0.1_gpt-4.json'))
#a = json.load(open('../LAVIS/complex_val_gpt4.json'))
#rompts_demo_gpt4 = [i['text'].lower() for i in a if i['text'].lower() in b and len(b[i['text'].lower()]) > 0]
#prompts_demo_gpt4 = list(b.keys())

# prompts_demo_gpt4 = ['A blue scooter is parked near a curb in front of a green vintage car']
#prompts_demo_gpt4 = ['an oil painting, where a green vintage car, a black scooter on the left of it and a blue bicycle on the right of it, are parked near a curb, with three birds in the sky']
